...
textFileLocation = 'C:\Users\clk0032\Dropbox\Friction Connection Research\Full Scale Test Data\FS Testing -ST2 - 02-16-16\'; %Location of File
textFileName     = 'fs testing -st2 - 02-11-16Run'; %Name of file to be processed
textFileSeed     = 100;
t_saveFileAs     = 'FS Testing - ST2 - Test 1 - 02-16-16'; %What to name file upon save
t_saveFileAs2    = sprintf('[Filter]%s',t_saveFileAs);
amount           = 30;
boltStrainGauge  = true;

if boltStrainGauge == true
    ...
    names = {'NormTime','run','sg1','sg2','sg3','sg4','sg5','sg6','sg7','sg8','sg9','sg10','sg11','sg12','sg13','sg14','sg15','sg16','sg17','sg18','sg19','sg20','sg21','sg22','wp11','wp12','wp21','wp22','wp31','wp32','wp41','wp42','wp51','wp61','wp62','LC1','LC2','LC3','LC4','MTSLC','MTSLVDT'};
